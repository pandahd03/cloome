...
def get_cellpainting_dataset(args, preprocess_fn, is_train):
    ...
    sampler = DistributedSampler(dataset, seed=args.seed) if args.distributed and is_train else None        #get sampler if for distributed learning
...
def get_imagenet(args, preprocess_fns, split):
    #used for geting imagenet dataset
    #not relevent for cloome
