...
class CellPainting(Dataset):
    def __init__(self, sample_index_file: str, image_directory_path: str = None, molecule_file: str = None, label_matrix_file: str = None,
        ...
        sample_index_file:                  filepath for metadata file
        image_directory_path:               filepath for image directory
        molecule_file:                      filepath for csv file with encoded smiles representation
        lable_matrix_file:                  ?
        label_row_index_file:               ?
        label_col_index_file:               ?
        auxiliary_labels:                   ?
        transforms:                         functions used for transforming images: normalize and image augmentation
        group_views:                        ?
        subset:                             if you want to get subset of data, should be in range [0,1]
        num_classes:                        ?
        verbose:                            if you want to print more
        """
...
if __name__ == "__main__":
    ...
    data = CellPainting(r"C:\Users\Jakob S\AI-Studium\5 Semester\Practical_Work\cloome\src\data\cellpainting-unique-molecule.csv",
                        r"C:\Users\Jakob S\AI-Studium\5 Semester\Practical_Work\paper-bray2017\npzs",
                        r"C:\Users\Jakob S\AI-Studium\5 Semester\Practical_Work\paper-bray2017\morgan_chiral_fps.hdf5")
